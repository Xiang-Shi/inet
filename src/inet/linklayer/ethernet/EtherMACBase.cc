...
bool EtherMACBase::dropFrameNotForUs(EtherFrame *frame)
{
   ...
   //             <<" , frame.passbacknum = "<<frame->getPassBackNum()<<endl;
        return false;
    }


  //  if(!(strcmp(getParentModule()->getParentModule()->getNedTypeName(),"inet.node.ethernet.EtherSwitch")==0)) // not in eth of switch
  //      EV_DETAIL<<"EtherMACBase :: dropFrameNotForUs, receiving frame in "<<getFullName()
  //              <<" , grand parent name = "<< getParentModule()->getParentModule()->getFullName()
  //              <<" , grand parent nodetype = "<< getParentModule()->getParentModule()->getNedTypeName()
  //              <<" , frame.passbacknum = "<<frame->getPassBackNum()<<endl;
