...
void EtherMAC::frameReceptionComplete()
{
    ...
    //SHI: If sender received passed back frame, don't discard
...
//SHI: IFG Period-- a brief recovery time between packets allows devices to prepare for reception of the next packet
