...
class INET_API EtherTrafGen : public cSimpleModule, public ILifecycle
{
  protected:
    ...
    cPar *pauseInterval = nullptr;
    cPar *numPacketsPerBurst = nullptr;
    cPar *numPacketsPerSend = nullptr;
    ...
    // receive statistics
    long numPacketsPerSendCounter = 0;
    long packetsSent = 0;
  ...
  protected:
    ...
    virtual void scheduleNextPacketForPause(simtime_t previous);
    virtual void scheduleNextPacketForSend(simtime_t previous);
