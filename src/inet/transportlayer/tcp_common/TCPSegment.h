...
//@{
inline bool seqLess(uint32 a, uint32 b) { return a != b && (b - a) < (1UL << 31); } //a<b
inline bool seqLE(uint32 a, uint32 b) { return (b - a) < (1UL << 31); } //a<=b
inline bool seqGreater(uint32 a, uint32 b) { return a != b && (a - b) < (1UL << 31); } //a>b
inline bool seqGE(uint32 a, uint32 b) { return (a - b) < (1UL << 31); } //a>=b
