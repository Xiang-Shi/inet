...
void TCPMsgBasedRcvQueue::init(uint32 startSeq)
{
    ...
    //payloadArraySizeStats.setName("payload array size statistics");
...
uint32 TCPMsgBasedRcvQueue::insertBytesFromSegment(TCPSegment *tcpseg)
{
    ...
    //unsigned int arraySize = tcpseg->getPayloadArraySize();
    //payloadArraySizeStats.collect(arraySize);
