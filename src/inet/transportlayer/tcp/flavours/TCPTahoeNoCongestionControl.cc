...
#include "inet/transportlayer/tcp/flavours/TCPTahoeNoCongestionControl.h"
...
Register_Class(TCPTahoeNoCongestionControl);

TCPTahoeNoCongestionControl::TCPTahoeNoCongestionControl() : TCPTahoeRenoFamily(),
    state((TCPTahoeNoCongestionControlStateVariables *&)TCPAlgorithm::state)
{
}



void TCPTahoeNoCongestionControl::initialize()
{
...
void TCPTahoeNoCongestionControl::recalculateSlowStartThreshold()
{
