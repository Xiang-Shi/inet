...
std::string TCPStateVariables::detailedInfo() const
{
    ...
    out << "iss=" << iss << "\n";
    out << "snd_seg=" << snd_seg << "\n";
    out << "retransmission_num=" << retransmission_num << "\n";
    out << "rcv_nxt=" << rcv_nxt << "\n";
    out << "rcv_wnd=" << rcv_wnd << "\n";
    out << "rcv_up=" << rcv_up << "\n";
    out << "irs=" << irs << "\n";
    out << "rcv_adv=" << rcv_adv << "\n";
    out << "rcv_buf_occup=" << rcv_buf_occup <<"\n";
...
TCPConnection::TCPConnection(TCP *_mod, int _appGateIndex, int _connId)
{
    ...
    if (getTcpMain()->recordStatistics) {
        ...
        //SHI: disorder
        disorderVector = new cOutVector("SHI: reordering density");
        payloadVector = new cOutVector("SHI: segment payload");
        test_vector = new cOutVector("SHI: tmp recorder to check truncate times...");

        pkDelayVector = new cOutVector("SHI: packet delay");
        ...
        sndSegVector = new cOutVector("SHI: sent seg sequence");
        resentSegVector = new cOutVector("SHI: resent segment sequenceNo");
        retransmissionVector = new cOutVector("SHI:retransmission times");
        ...
        rcvSegVector = new cOutVector("SHI: rcvd seg sequence");
        rcvNxtSeqVector = new cOutVector("SHI: rcv next sequence");
        rcvBufOccupVector = new cOutVector("SHI: receive buffer occupancy");
...
TCPConnection::~TCPConnection()
{
    ...
    // statistics
    delete disorderVector;
    delete pkDelayVector;
    delete payloadVector;
    delete test_vector;
    delete sndWndVector;
    delete rcvWndVector;
    delete rcvAdvVector;
    ...
    delete sndAckVector;
    delete sndSegVector;
    delete resentSegVector;
    delete retransmissionVector;
    delete rcvSeqVector;
    delete rcvAckVector;
    ...
    delete rcvSegVector;
    delete rcvNxtSeqVector;
    delete rcvBufOccupVector;
